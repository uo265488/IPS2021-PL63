...
public class EditorViewArticulosParaPublicar extends JDialog {
	...
	setTitle("Editor. Articulos pendientes de publicación");
	...
	EditorViewPublicarArticulo ven = new EditorViewPublicarArticulo(
		(getListArticulosParaPublicar().getSelectedValue()));
	ven.setVisible(true);
    }
