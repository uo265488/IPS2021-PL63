...
public class EditorViewDecisionArticulo extends JDialog {
	...
	setTitle("Editor. Decisión articulo");
	...
	if (listCambiosMenores.getSelectedValuesList().size() > 1)
		...
		if (articulo.getEstado().equals(ArticuloEntity.ACEPTADO_CAMBIOS_MENORES))
		    JOptionPane.showMessageDialog(null,
			    "Para un artículo con cambios menores solo se puede aceptar o rechazar",
		    ...
		    JOptionPane.showMessageDialog(this,
			    "El estado del artículo ahora es: " + ArticuloEntity.ACEPTADO_CAMBIOS_MENORES);
		...
		if (articulo.getEstado().equals(ArticuloEntity.ACEPTADO_CAMBIOS_MENORES))
		    ...
		    JOptionPane.showMessageDialog(this,
			    "El estado del artículo ahora es: " + ArticuloEntity.ACEPTADO_CAMBIOS_MAYORES);
		    modeloLista.removeElement(articulo);
		}
		break;
	    }
