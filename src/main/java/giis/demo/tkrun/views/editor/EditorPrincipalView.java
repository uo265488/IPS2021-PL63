...
//	}
	...
	if (btnDetallesArticulo == null) {
	    ...
	    btnDetallesArticulo.setBounds(495, 360, 150, 29);
	}
	...
	if (btnEstadoAsignaciones == null) {
	    ...
	    btnEstadoAsignaciones.setBounds(495, 326, 150, 23);
	}
	...
	if (btnFiltrar == null) {
	    ...
	    btnFiltrar.setBounds(263, 325, 89, 23);
	}
	return btnFiltrar;
    }
	...
	if (btnQuitarFiltros == null) {
	    ...
	    btnQuitarFiltros.setBounds(237, 359, 115, 23);
	}
	...
	if (cbBoxFiltrar == null) {
	    ...
	    cbBoxFiltrar.setBounds(151, 293, 105, 21);
	}
	return cbBoxFiltrar;
    }
	...
	if (lbFiltrar == null) {
	    ...
	    lbFiltrar.setBounds(86, 297, 71, 14);
	}
	return lbFiltrar;
    }
	...
	if (lbOrdenar == null) {
	    ...
	    lbOrdenar.setBounds(464, 116, 71, 21);
	}
	return lbOrdenar;
    }
	...
	if (pnOrdenar == null) {
	    ...
	    pnOrdenar.setBounds(540, 82, 105, 91);
	...
	if (sPArticulos == null) {
	    ...
	    sPArticulos.setBounds(26, 53, 429, 205);
	...
	if (txtFFiltrado == null) {
	    ...
	    txtFFiltrado.setBounds(266, 294, 86, 20);
