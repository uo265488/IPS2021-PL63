...
public class EditorAsignarFechasSegundaRevision extends JDialog {
     ...
     * Create the dialog.
     */
    public EditorAsignarFechasSegundaRevision(EditorController controller, ArticuloEntity articulo,
	    RevisorEntity revisor1, RevisorEntity revisor2, RevisorEntity revisor3) {
	setTitle("Editor. Asignación de fechas a los revisores");
	...
	if (getCbRevisor1().getSelectedIndex() != -1 && getCbRevisor1().getSelectedIndex() != -1
		&& getCbRevisor1().getSelectedIndex() != -1) {
