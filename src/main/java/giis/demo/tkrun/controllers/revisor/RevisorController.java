...
public class RevisorController {
    ...
    public RevisionEntity getRevision(String idArticulo, String idRevisor, int numeroRevision) {
	return EntityAssembler.toRevisionEntity(model.getRevisionByIds(idArticulo, idRevisor, numeroRevision));
    }
