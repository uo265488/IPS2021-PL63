...
insert into revisiones(idArticulo, idRevisor, numeroRevision, fecha, comentariosAutor, comentariosEditor, decision, enviarAlEditor, estadoDeLaPropuesta) values
	...
	(8, 1, 2,'31/12/2021', 'Con la modificacion me convence','Aceptaria','aceptar',true, 'ACEPTADO'),
	(8, 2, 2,'31/12/2021', 'Me ha gustado mucho','Aceptaria','aceptar',true, 'ACEPTADO'),
	(8, 3, 2,'31/12/2021', 'La modificacion no me acaba de convence','No lo aceptaria','rechazar',true, 'ACEPTADO'),
