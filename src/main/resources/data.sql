...
insert into revisores(idRevisor,nombre,estado, correo, especialidad) values 
	...
	(4,'carmen', 'NO DISPONIBLE', 'carmen@uniovi.es', 'Economía'),
	...
	(14, 'Cristiano R.', 'SUGERIDO', 'cr7@uniovi.es', 'Futbol');
...
insert into articulos(idArticulo,titulo,primerAutor,estado,resumen,palabrasClave,ficheroFuente,cartaPresentacion,CV, firma, vecesRevisado, versionDefinitiva, debatible) values 
	...
	(8,'Gasol se retira','lucia','con el editor', 'Gasol anuncia su retirada del baloncesto', 'gasol, leyenda, Barca', 'FicheroFuente.pdf', 'Presentacion.pdf', 'cv.pdf', false, 0, true, false),
	(9,'La caida de Facebook','ariadna','aceptado', 'Se caen los servidores de Facebook durante 6 horas con perdidas multimillonarias', 'facebook, red, caida', 'FicheroFuente.pdf', 'Presentacion.pdf', 'cv.pdf', false, 1, false, true),
	...
	(11,'El Quijote, la obra maestra','ariadna','aceptado', 'análisis profundo sobre El Quijote', 'literatura, historia', 'FicheroFuente.pdf', 'Presentacion.pdf', 'cv.pdf', false, 1, false, true),
	...
	(13,'Nuevo Articulo','lucia','con el editor', 'algo', 'literatura, historia', 'FicheroFuente.pdf', 'Presentacion.pdf', 'cv.pdf', false, 0, false, true),
	...
	(15,'La luz no para de subir','ariadna','en revision', 'otro máximo histórico de la luz en España', 'luz, máximo, economía', 'FicheroFuente.pdf', 'Presentacion.pdf', 'cv.pdf', false, 1, false, true),
	(16,'Violencia en los colegios', 'lucia','con el editor','la violecia es cada vez más preocupente en los colegios','violencia, colegios, Lesiones','FicheroFuente.pdf', 'Presentacion.pdf', 'cv.pdf', false, 0, false, false),
	(17,'Hola','hugo','borrador','','','','','',false, 0, false, true),
		
	(101, 'Articulo sin asginar para rechazar', 'hugo', 'con el editor', 'si', 'no', 'fichero', 'presentacion', 'cv', false, 0, false, true);
